...
public class Kompleksiluku {
    ...
    /**
     * Vastaa kompleksiluvun x-koordinaattia.
     */
    private double xKoordinaatti;
    /**
     * Vastaa kompleksiluvun y-koordinaattia.
     */
    ...
    /**
     * Metodi summaa nykyiseen kompleksilukuun parametrina annetun
     * kompleksiluvun ja palauttaa tuloksen.
     *
     * @param summattava
     * @return
     */
    ...
    /**
     * Metodi laskee tämän kompleksiluvun potenssin käyttäen annettua
     * parametria. Tämän jälkeen palautetaan tulos ja null, jos tulos
     * määrittämätön.
     *
     * @param potenssi
     * @return
    ...
    /**
     * Metodi laskee tämän kompleksiluvun käänteisluvun ja palauttaa tuloksen
     * tai nullin, jos tulos määrittämätön.
     *
     * @return
     */
    ...
    /**
     * Metodi palauttaa kompleksiluvun, jonka koordinaatit ovat tämän
     * kompleksiluvun koordinaattien itseisarvot.
     *
     * @return
     */
